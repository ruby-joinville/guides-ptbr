...
+ Gem Management
+ MVC, REST/Resources
+ Modelos (models) e Active Record
+ Controladores (controllers) e ActionController
+ Visões (views) e ERB
...
* Aborde coachs locais - tente encontrar cinco pessoas que se comprometam a participar
